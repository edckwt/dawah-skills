...
class app_ds_helpers {
	...
	function opic_admin_tabs($current = 'language') {
		...
		global $opicds_categories_lang,$dscategories;
		if (!empty($_POST[OPICDS_Input_SLUG.'language'])) {
			$this->class_lang = fun_ds_loadlang();
		}
		
		$cat_tab_list = $opicds_categories_lang[get_option(OPICDS_Input_SLUG.'language')];
