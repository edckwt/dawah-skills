...
<div class="category-head">
		...
		<tr>
			<td width="80px">
				<span class="category-logo"><?php echo opicds_icon_logo('options.png',array('width'=>'80px')) ?></span>
				</td>
			<td>
...
echo $DSHtml -> Input('select', array('name' => 'cronjobtime', 'options' => $timeList, 'label' =>$this->getLang('label-import_data_time')));
echo $DSHtml->Input('text',array('name' => 'source', 'label' => $this->getLang('label-source')));
?>